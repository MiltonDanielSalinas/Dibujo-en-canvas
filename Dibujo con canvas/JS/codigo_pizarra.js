...
limpiar_canvas.addEventListener("click", (e) => {
...
var boton_color_trazo_usuario = document.getElementById(
  "boton_trazo_hexadecimal"
);
boton_color_trazo_usuario.addEventListener("click", (e) => {
  color_trazo = "#" + color_trazo_usuario.value;
});
...
var boton_color_fondo_usuario = document.getElementById(
  "boton_fondo_hexadecimal"
);
...
function mover_mouse(evento_mover) {
  if (dibujando == true) {
    dibujarlinea(
      ...
      x,
      y,
      evento_mover.offsetX,
      evento_mover.offsetY,
      lienzo
    );
...
function mover_borrador(evento_mover_borrador) {
  if (borrando == true) {
    borrador_pizarra(
      ...
      x,
      y,
      evento_mover_borrador.offsetX,
      evento_mover_borrador.offsetY,
      lienzo
    );
